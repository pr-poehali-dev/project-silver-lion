      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            ...
            >
              Напиши нам — расскажи о себе и своих интересах. Мы ответим и поможем найти своё место в пространстве.
            </p>
            ...
            >
              ...
              <div>
                ...
                <p className="text-foreground">Корпус техникума, 2 этаж</p>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Расскажи о себе и своих интересах..."
                  required
                />
              </div>
              <button
