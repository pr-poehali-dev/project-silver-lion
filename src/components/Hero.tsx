  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Молодёжное пространство техникума
        </p>
        ...
        >
          Место, где
          <span className="block text-sage">рождаются идеи</span>
        </h1>
        ...
        >
          Живое сообщество студентов, где каждый может развиваться, творить и находить единомышленников. Мероприятия, проекты и возможности — всё в одном месте.
        </p>
