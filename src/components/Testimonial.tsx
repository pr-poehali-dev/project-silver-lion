  ...
  return (
    <section ref={sectionRef} className="py-32 lg:py-40 px-6 lg:px-12 bg-sage">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          Здесь я нашёл настоящих друзей и впервые поучаствовал в реальном проекте. Пространство дало мне уверенность в себе и понимание, чего я хочу достичь.
        </blockquote>
        ...
        >
          <p className="text-sm tracking-widest uppercase text-primary-foreground/80">Максим, студент 3 курса</p>
          <p className="text-sm text-primary-foreground/60 mt-1">Специальность — Программирование</p>
        </div>
      </div>
    </section>
  )
